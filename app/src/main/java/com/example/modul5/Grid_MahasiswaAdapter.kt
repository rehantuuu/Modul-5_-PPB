...
class Grid_MahasiswaAdapter (private val grid_mhs : List<Iris_Variable>, val listener: (Iris_Variable) -> Unit) :
    ...
    class GridViewHolder(view: View) :RecyclerView.ViewHolder(view){
        ...
        fun bindView(grid_mhs: Iris_Variable, listener: (Iris_Variable) -> Unit){
